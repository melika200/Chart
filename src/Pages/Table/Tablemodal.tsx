  ...
  return (
    <div>
      <Button onClick={handleOpen}>
        ...
        >
          <Typography className="adddoc">افزودن مدرک تحصیلی</Typography>{" "}
          <LuBookmarkPlus className="doc" />
        </Box>
      </Button>
      ...
      >
        <Box sx={style}>
          ...
          <Box
            component="form"
            sx={{
              "& .MuiTextField-root": { m: 1, width: "45ch", direction: "rtl" },
            }}
            noValidate
            autoComplete="off"
          >
            ...
            >
              ...
              >
                ...
                <LuBookmarkPlus className="modalicon" />{" "}
              </Box>
